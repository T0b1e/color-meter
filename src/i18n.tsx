...
export const translations = {
  th: {
    ...
    wbBody: 'แสงแต่ละแหล่งมีอุณหภูมิสี (Kelvin) ต่างกัน เมื่อกล้องปรับไวต์บาลานซ์ผิด ค่าสีทุกค่าจะเบี่ยงเบน เช่น วัตถุสีขาวใต้หลอดทังสเตนจะอ่านค่าเป็นสีส้ม นี่คือ สาเหตุอันดับ 1 ของความคลาดเคลื่อน',
    ispTitle: '2. การประมวลผลภาพในกล้อง (ISP)',
    ispBody: 'กล้องปรับแก้อัตโนมัติก่อนที่คุณจะเห็นพิกเซล ได้แก่ ปรับแสงอัตโนมัติ, ไวต์บาลานซ์อัตโนมัติ, โทนแมปปิง, เพิ่มความอิ่มตัวสี (โทรศัพท์ส่วนใหญ่เพิ่มเกินจริง)',
    ispResearch: 'ผลวิจัย: กล้องสมาร์ตโฟนมักประเมิน Saturation สูงเกินจริง และ Value ต่ำกว่าค่า Pantone อ้างอิง',
    surfaceTitle: '3. วัสดุพื้นผิว',
    // Delta E
    deltaETitle: 'มาตรฐานความแม่นยำสี — Delta E (ΔE)',
    deltaEBody: 'ΔE คือมาตรฐานสากล (CIE) ในการวัดความต่างของสีในพื้นที่สี CIELAB ซึ่งออกแบบให้ค่าที่เท่ากันสอดคล้องกับการรับรู้ที่เท่ากัน',
    deltaETarget: 'เป้าหมาย: ΔE ≤ 2 สำหรับงานที่ต้องการความแม่นยำสูง',
    deltaEScale: ['0 = เหมือนกันสมบูรณ์', '0–1 = แยกไม่ออก', '1–2 = เห็นต่างได้เฉพาะผู้เชี่ยวชาญ', '2–3 = เห็นต่างเมื่อเทียบชิดกัน', '3–5 = เห็นต่างชัดเจน', '5+ = ต่างกันมาก'],
    // Practical tips
    lightingTitle: 'แสงสว่าง — ปัจจัยสำคัญที่สุด',
    lightingBest: 'แนะนำ: แสงขาวนวล กระจายตัวดี อุณหภูมิ 5000–5500 K ส่องจากด้านหน้าวัตถุในมุม ~45°',
    wbLockTitle: 'ล็อกไวต์บาลานซ์',
    wbLockBody: 'ห้ามใช้ Auto WB ขณะวัดสี — กล้องปรับค่าตลอดเวลาทำให้ผลเปลี่ยนแปลง กด tap-and-hold บนโทรศัพท์เพื่อล็อกโฟกัสและแสง',
    samplingTitle: 'เทคนิคการวัด',
    uploadVsCameraTitle: 'โหมดอัปโหลด vs กล้อง',
    uploadVsCameraBody: 'โหมดอัปโหลดแม่นยำกว่า สำหรับวัตถุนิ่ง เพราะควบคุมแสงได้, เลือกพิกเซลได้แม่นยำ, ไม่มีการเบี่ยงเบนของ AWB แบบเรียลไทม์',
    // Color space guide
  ...
  en: {
    ...
    guideSubtitle: 'Research-backed guidelines for getting readings as close to ground truth as possible.',
    // Core problem
    coreTitle: 'Why Camera Color ≠ True Color',
    wbTitle: '1. White Balance / Color Temperature',
    wbBody: 'Light sources have different temperatures (Kelvin). When the camera white balance is wrong, every color reading shifts. A white object under tungsten light reads as orange. This is the #1 source of inaccuracy.',
    ispTitle: '2. In-Camera Image Processing (ISP)',
    ispBody: 'Cameras apply automatic corrections before you see any pixel: auto-exposure, auto white balance, tone mapping, and saturation enhancement (most phones over-saturate).',
    ispResearch: 'Research finding: Smartphone cameras systematically overestimate Saturation and underestimate Value compared to Pantone reference values.',
    surfaceTitle: '3. Surface / Material Effects',
    // Delta E
    deltaETitle: 'Color Accuracy Standard — Delta E (ΔE)',
    deltaEBody: 'ΔE is the international CIE standard for quantifying color difference, calculated in CIELAB color space — designed so equal ΔE values correspond to equal perceived differences.',
    deltaETarget: 'Target: ΔE ≤ 2 for professional color-accurate work.',
    deltaEScale: ['0 = Perfect match', '0–1 = Imperceptible', '1–2 = Barely perceptible (trained eye)', '2–3 = Noticeable on close comparison', '3–5 = Clearly visible', '5+ = Strong color difference'],
    // Practical tips
    lightingTitle: 'Lighting — the single biggest factor',
    lightingBest: 'Best setup: soft, diffused, neutral-white light (5000–5500 K) hitting the object from the front at ~45°.',
    wbLockTitle: 'Lock White Balance',
    wbLockBody: 'Never use Auto WB when measuring color — the camera continuously re-estimates white balance and shifts readings. Tap-and-hold on a phone to lock focus and exposure.',
    samplingTitle: 'Sampling Technique',
    uploadVsCameraTitle: 'Upload Mode vs Camera Mode',
    uploadVsCameraBody: 'Upload mode is more accurate for static objects: you control lighting at capture, choose the exact pixel by clicking, and there is no real-time AWB drift.',
    // Color space guide
